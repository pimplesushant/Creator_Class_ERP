...
<html lang="en">
	<head>
		...
		<link href="<?php echo base_url('assets/css/tsc_datagrid.css') ?>" rel="stylesheet">
		...
		<script src="<?php echo base_url('assets/js/bootstrap-fileupload.min.js') ?>"></script>
         <script src="<?php echo base_url('assets/js/tsc_datagrid.js') ?>"></script>			
			...
			<div class="navbar-inner">
				<ul class="nav">
					...
					<ul class="dropdown-menu">
						...
						<li><?php echo anchor('home/addclass', 'Add Class'); ?></li>
						<li><?php echo anchor('home/addclass', 'Add Class'); ?></>
						<li><?php echo anchor('home/addclass', 'Add Class'); ?></
						<li><?php echo anchor('home/addclass', 'Add Class'); ?></
						<li><?php echo anchor('designation_controlller', 'Add designation'); ?></li>
