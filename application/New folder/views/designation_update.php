...
<legend>Add Designation</legend>
  ...
  <div class="control-group">
	<label class="control-label">Designation Name</label>
	  <div class="controls">
		 <input type="text" class="input-xlarge" id="designation_name" name="designation_name" value="<?php echo $row[0]->designation_name; ?>"> 
	...
	<div class="control-group">
	 ...
	 <div class="controls">
		  <textarea class="input-xlarge" id="description" name="description" value="" ><?php echo $row[0]->description; ?>
		  </textarea>
