...
<div class="container"> 
	<legend>Class</legend>
	<a class="btn" href="<?php echo('show_grid'); ?>">Show All Classes</a>
	<div class="container ">&nbsp;
	<div class="alert alert-success">
    <strong>Success...!</strong> Class Added Successfully.....!!!
    </div>
	</div>
	<fieldset style="border:2px solid #C0C0C0; padding:20px; background-color:#f8f8f8;">
		<form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="<?php echo $class=site_url('class_controller/class_add'); ?>"  >
			...
			<div class="controls">
				<input type="text" required class="input-large" id="telephone_no" name="telephone_no" placeholder="Phone Number">
