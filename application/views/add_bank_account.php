...
color:red;
	...
	<fieldset>
		<form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="<?php echo $bank; ?>"  >
			...
			<div class="controls">
				<textarea rows="2" name="bank_address" id="bank_address" required placeholder="House, Landmark, City, Pincode"></textarea>
			...
			<div class="controls">
				<input type="text"  class="input-large" id="account_number" name="account_number" placeholder="Account Number">
			...
			<div class="controls">
				<input class="input-large" id="ifsc" name="ifsc"  required type="text" placeholder="11 Digit IFS Code">
			...
			<div class="controls">
				<input class="input-large" id="micr" name="micr"  required type="text" placeholder="9 Digit MICR Code">
